...
train_clean = AudioDataset(
    "processed_data/train",
    use_noise=False
)

train_noisy = AudioDataset(
...
for epoch in range(epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(
            student.state_dict(),
            "model/best_model_fkd_noise_noES.pth"
        )
...
np.save(
    "evaluasi/train_loss_fkd_noise_noES.npy",
    np.array(train_losses)
)

np.save(
    "evaluasi/val_loss_fkd_noise_noES.npy",
    np.array(val_losses)
)
...
print("Model saved      : model/best_model_fkd_noise_noES.pth")
print("Loss history saved in /evaluasi")
print("====================================")

print("🔥 Training skenario 4 tanpa early stopping selesai!")